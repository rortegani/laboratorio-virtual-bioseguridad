...
export class Laboratory {
  ...
  private build(): void {
    ...
    addBox(new THREE.Vector3(0.25, 3, 16), new THREE.Vector3(-9, 1.5, 7), 0xd7e1df);
    addBox(new THREE.Vector3(0.25, 3, 16), new THREE.Vector3(9, 1.5, 7), 0xd7e1df);
    const wallSideWidth = (ROOM_WIDTH - DOOR_WIDTH) / 2;
    addBox(new THREE.Vector3(wallSideWidth, DOOR_HEIGHT, 0.25), new THREE.Vector3(-(ROOM_WIDTH + DOOR_WIDTH) / 4, DOOR_HEIGHT / 2, DOOR_Z), 0xd7e1df);
    addBox(new THREE.Vector3(wallSideWidth, DOOR_HEIGHT, 0.25), new THREE.Vector3((ROOM_WIDTH + DOOR_WIDTH) / 4, DOOR_HEIGHT / 2, DOOR_Z), 0xd7e1df);
    addBox(new THREE.Vector3(10, 3, 0.25), new THREE.Vector3(-4, 1.5, 21), 0xc7d5d4);
    addBox(new THREE.Vector3(10, 3, 0.25), new THREE.Vector3(4, 1.5, 21), 0xc7d5d4);
    addBox(new THREE.Vector3(0.25, 3, 6), new THREE.Vector3(-9, 1.5, 18), 0xc7d5d4);
    addBox(new THREE.Vector3(0.25, 3, 6), new THREE.Vector3(9, 1.5, 18), 0xc7d5d4);
    this.doorRoot.position.set(-DOOR_WIDTH / 2, 0, DOOR_Z); this.scene.add(this.doorRoot);
    const doorPanel = new THREE.Mesh(new THREE.BoxGeometry(DOOR_WIDTH, DOOR_HEIGHT, 0.18), mat(0x5f9690)); doorPanel.position.set(DOOR_WIDTH / 2, DOOR_HEIGHT / 2, 0); this.doorRoot.add(doorPanel);
    ...
    const molecularTable = new THREE.Mesh(new THREE.BoxGeometry(3.4, 0.25, 2.1), mat(0x789293)); molecularTable.position.set(6.7, 1.2, 19.3); this.scene.add(molecularTable);
    ...
    addPanel(this.incidentRoot, new THREE.Vector3(-7, 1.1, 19.6), 0xc98265);
    addPanel(this.activityControlRoot, new THREE.Vector3(-7, 1.1, 17.1), 0x789293);
    addPanel(this.reportSystemRoot, new THREE.Vector3(7, 1.1, 17.1), 0x789293);
    addPanel(this.emergencyStationRoot, new THREE.Vector3(7, 1.1, 20), 0x789293);
    addPanel(this.wasteRoot, new THREE.Vector3(-3.5, 1.1, 20), 0x789293);
    addPanel(this.closeoutRoot, new THREE.Vector3(3.5, 1.1, 20), 0x789293);
